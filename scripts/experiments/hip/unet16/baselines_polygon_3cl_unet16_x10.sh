...
for i in {0..9}; do
  params="experiment=cb55_polygon_3cl_train_20_run_unet.yaml
      ...
      name=baseline_csg18_polygon_3cl_unet16_loss_no_weights_100_ep
      logger.wandb.tags=[unet16,polygon,csg18,3-classes,100-epochs,no-weights,baseline]
      logger.wandb.project=hip
...
for i in {0..9}; do
  params="experiment=cb55_polygon_3cl_train_20_run_unet.yaml
      ...
      name=baseline_csg863_polygon_3cl_unet16_loss_no_weights_100_ep
      logger.wandb.tags=[unet16,polygon,csg863,3-classes,100-epochs,no-weights,baseline]
      logger.wandb.project=hip
