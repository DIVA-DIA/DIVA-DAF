...
for j in "${!weights_10[@]}"; do
  params="experiment=fine_tune_cb55_polygon_unet.yaml
          ...
          name=FT_sauvola_rlsa_new_3cl_cb55_polygon_unet16_loss_no_weights_10pt_100e
          logger.wandb.project=hip
          logger.wandb.tags=[unet16,cb55,polygon,3-classes,fine-tune,100-epochs,no-weights,3cl_new,rlsa_new_3cl,new_heuristic,10-epoch-pt]
...
for j in "${!weights_20[@]}"; do
  params="experiment=fine_tune_cb55_polygon_unet.yaml
          ...
          name=FT_sauvola_rlsa_new_3cl_cb55_polygon_unet16_loss_no_weights_20pt_100e
          logger.wandb.project=hip
          logger.wandb.tags=[unet16,cb55,polygon,3-classes,fine-tune,100-epochs,no-weights,3cl_new,rlsa_new_3cl,new_heuristic,20-epoch-pt]
...
for j in "${!weights_30[@]}"; do
  params="experiment=fine_tune_cb55_polygon_unet.yaml
          ...
          name=FT_sauvola_rlsa_new_3cl_cb55_polygon_unet16_loss_no_weights_30pt_100e
          logger.wandb.project=hip
          logger.wandb.tags=[unet16,cb55,polygon,3-classes,fine-tune,100-epochs,no-weights,3cl_new,rlsa_new_3cl,new_heuristic,30-epoch-pt]
...
for j in "${!weights_40[@]}"; do
  params="experiment=fine_tune_cb55_polygon_unet.yaml
          ...
          name=FT_sauvola_rlsa_new_3cl_cb55_polygon_unet16_loss_no_weights_40pt_100e
          logger.wandb.project=hip
          logger.wandb.tags=[unet16,cb55,polygon,3-classes,fine-tune,100-epochs,no-weights,3cl_new,rlsa_new_3cl,new_heuristic,40-epoch-pt]
...
for j in "${!weights_50[@]}"; do
  params="experiment=fine_tune_cb55_polygon_unet.yaml
          ...
          name=FT_sauvola_rlsa_new_3cl_cb55_polygon_unet16_loss_no_weights_50pt_100e
          logger.wandb.project=hip
          logger.wandb.tags=[unet16,cb55,polygon,3-classes,fine-tune,100-epochs,no-weights,3cl_new,rlsa_new_3cl,new_heuristic,50-epoch-pt]
