...
#          name=FT_sauvola_rlsa_new_3cl_csg18_polygon_unet_loss_no_weights_10pt_100e
#          logger.wandb.project=hip
#          logger.wandb.tags=[unet,csg18,polygon,3-classes,fine-tune,100-epochs,no-weights,3cl_new,rlsa_new_3cl,new_heuristic,10-epoch-pt,with_header]
...
#          mode=hip.yaml
#          +model.backbone.path_to_weights=${weights_10[$j]}
#          name=FT_sauvola_rlsa_new_3cl_csg863_polygon_unet_loss_no_weights_10pt_100e
#          logger.wandb.project=hip
#          logger.wandb.tags=[unet,csg863,polygon,3-classes,fine-tune,100-epochs,no-weights,3cl_new,rlsa_new_3cl,new_heuristic,10-epoch-pt,with_header]
...
#          name=FT_sauvola_rlsa_new_3cl_csg18_polygon_unet_loss_no_weights_20pt_100e
#          logger.wandb.project=hip
#          logger.wandb.tags=[unet,csg18,polygon,3-classes,fine-tune,100-epochs,no-weights,3cl_new,rlsa_new_3cl,new_heuristic,20-epoch-pt,with_header]
...
#          mode=hip.yaml
#          +model.backbone.path_to_weights=${weights_20[$j]}
#          name=FT_sauvola_rlsa_new_3cl_csg863_polygon_unet_loss_no_weights_20pt_100e
#          logger.wandb.project=hip
#          logger.wandb.tags=[unet,csg863,polygon,3-classes,fine-tune,100-epochs,no-weights,3cl_new,rlsa_new_3cl,new_heuristic,20-epoch-pt,with_header]
...
#          name=FT_sauvola_rlsa_new_3cl_csg18_polygon_unet_loss_no_weights_30pt_100e
#          logger.wandb.project=hip
#          logger.wandb.tags=[unet,csg18,polygon,3-classes,fine-tune,100-epochs,no-weights,3cl_new,rlsa_new_3cl,new_heuristic,30-epoch-pt,with_header]
...
#          mode=hip.yaml
#          +model.backbone.path_to_weights=${weights_30[$j]}
#          name=FT_sauvola_rlsa_new_3cl_csg863_polygon_unet_loss_no_weights_30pt_100e
#          logger.wandb.project=hip
#          logger.wandb.tags=[unet,csg863,polygon,3-classes,fine-tune,100-epochs,no-weights,3cl_new,rlsa_new_3cl,new_heuristic,30-epoch-pt,with_header]
...
for j in "${!weights_40[@]}"; do
  params_18="experiment=fine_tune_csg18_polygon_unet.yaml
          ...
          name=FT_encoder_sauvola_rlsa_new_3cl_csg18_polygon_unet_loss_no_weights_40pt_100e
          logger.wandb.project=hip
          logger.wandb.tags=[unet,csg18,polygon,3-classes,fine-tune,100-epochs,no-weights,3cl_new,rlsa_new_3cl,new_heuristic,40-epoch-pt,with_header]
...
#          mode=hip.yaml
#          +model.backbone.path_to_weights=${weights_40[$j]}
#          name=FT_sauvola_rlsa_new_3cl_csg863_polygon_unet_loss_no_weights_40pt_100e
#          logger.wandb.project=hip
#          logger.wandb.tags=[unet,csg863,polygon,3-classes,fine-tune,100-epochs,no-weights,3cl_new,rlsa_new_3cl,new_heuristic,40-epoch-pt,with_header]
...
#          +model.backbone.layers_to_load=[layers.0,layers.1,layers.2,layers.3,layers.4]
#          name=FT_encoder_sauvola_rlsa_new_3cl_csg18_polygon_unet_loss_no_weights_50pt_100e
#          logger.wandb.project=hip
#          logger.wandb.tags=[unet,csg18,polygon,3-classes,fine-tune,100-epochs,no-weights,3cl_new,rlsa_new_3cl,new_heuristic,50-epoch-pt,with_header]
...
#          mode=hip.yaml
#          +model.backbone.path_to_weights=${weights_50[$j]}
#          name=FT_sauvola_rlsa_new_3cl_csg863_polygon_unet_loss_no_weights_50pt_100e
#          logger.wandb.project=hip
#          logger.wandb.tags=[unet,csg863,polygon,3-classes,fine-tune,100-epochs,no-weights,3cl_new,rlsa_new_3cl,new_heuristic,50-epoch-pt,with_header]
