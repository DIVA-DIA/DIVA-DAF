...
for j in "${!weights_bb[@]}"; do
  params="experiment=fine_tune_csg863_polygon_unet.yaml
          ...
          name=fine_tune_sauvola_rlsa_new_3cl_csg863_polygon_unet_loss_no_weights_w_header_50pt_100e
          ...
          logger.wandb.group=fine-tune-sauvola-rlsa-new-3cl-csg863-polygon-w-header-50pt"
