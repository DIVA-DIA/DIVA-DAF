...
def test_semantic_segmentation(data_dir_cropped, tmp_path):
    ...
    print(results)
    assert np.isclose(results[0]['test/crossentropyloss'], 1.0625288486480713, atol=1e-01)
    assert np.isclose(results[0]['test/crossentropyloss_epoch'], 1.0625288486480713, atol=1e-01)
